...
import org.photonvision.vision.pipeline.result.PythonPipelineResult;

public class PythonPipeline
        extends CVPipeline<PythonPipelineResult, PythonPipelineSettings> {
    ...
    protected void setPipeParamsImpl() {
        PythonPipe.PythonParams pythonParams =
                new PythonPipe.PythonParams("moduleName");
        pythonPipe.setParams(pythonParams);
    ...
    @Override
    public PythonPipelineResult process(Frame frame, PythonPipelineSettings settings) {
        long totalNanos = 0;
        ...
        return new PythonPipelineResult(
